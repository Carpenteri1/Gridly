...
describe('HeaderComponent', () => {
  ...
  beforeEach(async () => {
    ...
    cardServiceMock.saveLayout.mockResolvedValue(undefined);
    cardServiceMock.add.mockClear();
    cardServiceMock.saveLayout.mockClear();
  ...
  it('delegates add and save actions to the injected services', async () => {
    ...
    expect(cardServiceMock.saveLayout).toHaveBeenCalledWith(currentCards);
