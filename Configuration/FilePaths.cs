...
{
    private const string JsonFixedRateLimiterFileName = "fixedRateLimitWindowData.json";
    private const string VersionDataFileName = "versionData.json";
    private const string JsonComponentFileName = "componentData.json";

    public static readonly string FixedRateLimitFilePath = Path.Combine(Directory.GetCurrentDirectory(),"Assets/RateLimiterData", JsonFixedRateLimiterFileName);
